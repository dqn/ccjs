...
assert 111 'main() {int b;b=123;b=b-12;}'
assert 20 'main() {int b;int c;c=30;b=10;c-b;}'
assert 6 'main() {int foo;int bar;foo=1;bar=2+3;foo+bar;}'
assert 10 'main() {return 10;}'
assert 7 'main() {int aa;int bb;aa=4;bb=3;return aa+bb;}'
...
assert 0 'main() {int a;a=3;while(a)a=a-1;a;}'
assert 2 'main() {int a;a=3;while(a)return 2;a;}'
assert 7 'main() {int a;int i;a=10;for(i=0;i<3;i=i+1)a=a-1;a;}'
assert 3 'main() {int a;a=0;for(;a<3;)a=a+1;a;}'
assert 1 'main() {int i;for (i=0;i<10;i=i+1) { if (i == 5) { return 1; } } return 0;}'
assert 14 'main() {int a;a=0; for (;;) { a = a+2; if (a > 12) return a; } }'
...
assert 2 'main() { int a;int b;a = 1; b = 2; return *(&a - 8); }'
